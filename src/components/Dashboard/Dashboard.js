    ...
    <div className={classes.root}>
      ...
      >
        <Toolbar>
          ...
          <Typography style={{ display: appointment ? 'block' : 'none' }} variant="h6" noWrap>
            Appointment
           </Typography>
              ...
              <div className="col-md-12">
                <table className="table table-borderless">
                  ...
                  <tbody>
                    ...
                    {
                      allPatient.map(patient => <RecentAppointment patient={patient} key={patient._id} sl={SlNo++}></RecentAppointment>)
                    }
                  </tbody>
                </table>
              </div>
