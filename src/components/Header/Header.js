...
const Header = () => {
    ...
    return (
        ...
        <div >
                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-md-5 left-side">
                            {
                                <div style={{ display: appointment && 'none' }}>
                                    ...
                                    <Button className="left-button" onClick={handleAppointment} variant="contained" color="primary">Get Appointment</Button>
                                </div>
                            }
                            {
            ...
            <div style={{ display: appointment ? 'block' : 'none' }} className="container">
            ...
            <div style={{ display: appointment ? 'block' : 'none' }} className="container">
                <div className="row">
                    {
                        appointmentDetails.map(appointment => <Appointment handleModalOpen={handleModalOpen} key={appointment.key} item={appointment}></Appointment>)
                    }
                </div>
            </div>
